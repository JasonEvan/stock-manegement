 ...
 * @author jasonevan
 */
public class EditReturPembelian extends javax.swing.JPanel {
    ...
    public EditReturPembelian(java.sql.Connection conn, javax.swing.JFrame parentFrame, 
    ...
    private void simpanButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanButtonActionPerformed
        ...
        try (java.sql.PreparedStatement stmt = cons.prepareStatement("SELECT tanggal_retur FROM bretur WHERE nomor_nota = ?"))
        {
            stmt.setString(1, nomorNotaString);
            java.sql.ResultSet resultSet = stmt.executeQuery();
            while (resultSet.next()) {
        ...
        // Hapus data yg di bretur dulu
        query = "DELETE FROM bretur WHERE nomor_nota = ?";
    ...
    private void setNota() {
        ...
        try (java.sql.PreparedStatement stmt = cons.prepareStatement("SELECT id_beli, nama_barang, harga_barang, "
                + "qty_barang, total_harga FROM bretur WHERE nomor_nota = ?")) {
            stmt.setString(1, nomorNota.getSelectedItem().toString());
            java.sql.ResultSet resultSet = stmt.executeQuery();
            while (resultSet.next()) {
                String[] row = {
                    String.valueOf(resultSet.getInt("id_beli")),
                    resultSet.getString("nama_barang"),
                    String.valueOf(resultSet.getInt("harga_barang")),
                    String.valueOf(resultSet.getInt("qty_barang")),
                    String.valueOf(resultSet.getInt("total_harga"))
    ...
    private boolean validateAll() {
        ...
        try (java.sql.PreparedStatement stmt = cons.prepareStatement("SELECT * FROM bretur WHERE nomor_nota = ?"))
        {   
            String nomorNotaString = nomorNota.getSelectedItem().toString();
