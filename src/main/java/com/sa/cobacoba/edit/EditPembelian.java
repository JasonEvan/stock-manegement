...
public class EditPembelian extends javax.swing.JPanel {
    ...
    public EditPembelian(java.sql.Connection conn, javax.swing.JFrame parentFrame, 
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Edit Pembelian");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Nama Barang", "Jumlah Barang", "Harga Beli", "Total Harga"
            }
        ) {
...
//        GET NOMOR NOTA
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        ...
        // tampilin data
        try (java.sql.PreparedStatement stmt = cons.prepareStatement("SELECT * FROM beli WHERE nomor_nota = ?"))
        {
            stmt.setString(1, nomorNotaString);
            java.sql.ResultSet resultSet = stmt.executeQuery();
            while (resultSet.next()) {
    ...
    private void deleteOldData() {
        ...
        // delete database beli
        try (java.sql.PreparedStatement stmt = cons.prepareStatement("DELETE FROM beli WHERE id = ?"))
        {
            stmt.setInt(1, id);
            stmt.execute();
        } catch (java.sql.SQLException e) {
        ...
        try (java.sql.PreparedStatement stmt = cons.prepareStatement("UPDATE client SET sldakhir_utang = sldakhir_utang - ? WHERE id = ?"))
        {
    ...
    private void insertNewData(String namaBarangString, int satuHarga, int stockInt) {
        ...
        try (java.sql.PreparedStatement stmt = cons.prepareStatement("SELECT * FROM beli WHERE nomor_nota = ? LIMIT 1"))
        {
        ...
        // nota di bnota diupdate nilai_notanya
        try (java.sql.PreparedStatement stmt = cons.prepareStatement("UPDATE bnota SET nilai_nota = ? WHERE nomor_nota = ?"))
        {
        ...
        // tambahin stock di database stock dan tambah qty_in
        try (java.sql.PreparedStatement stmt = cons.prepareStatement("UPDATE stock SET stock_akhir = stock_akhir + ?, "
                + "qty_in = qty_in + ? WHERE nama_barang = ?"))
        {
            stmt.setInt(1, stockInt);
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        // update diskon_nota db beli
        try (java.sql.PreparedStatement stmt = cons.prepareStatement("UPDATE beli SET diskon_nota = ? WHERE nomor_nota = ?"))
        {
        ...
        // update diskon_nota, nilai_nota, saldo_nota di db bnota
