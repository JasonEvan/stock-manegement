 ...
 * @author jasonevan
 */
public class ReturPembelian extends javax.swing.JPanel {

    java.sql.Connection cons;
    javax.swing.JFrame parentFrame;
    public ReturPembelian(java.sql.Connection conn, javax.swing.JFrame parentFrame) {
        cons = conn;
    ...
    private void setTodayDate() {
        ...
        tanggalRetur.addItem(formattedDate);
        tanggalRetur.setSelectedIndex(-1);
    }
    ...
    private void initComponents() {
        ...
        tanggalRetur = new javax.swing.JComboBox<>();
        ...
        tanggalRetur.setEditable(true);
        tanggalRetur.setFont(new java.awt.Font("Helvetica Neue", 0, 16)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(tanggalRetur, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(tanggalRetur, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        tableNota.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Nama Barang", "Harga Beli", "Jumlah", "Total Harga"
            }
        ) {
    ...
    private void namaClientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_namaClientActionPerformed
        ...
        try (java.sql.PreparedStatement stmt = cons.prepareStatement("SELECT nomor_nota FROM bnota "
                + "WHERE id_client = ?"))
        {
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        tanggalRetur.setEditable(false);
        tanggalRetur.setEnabled(false);
    ...
    private void returButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_returButtonActionPerformed
        ...
        int hargaBeliInt = Integer.parseInt(notaModel.getValueAt(tableNota.getSelectedRow(), 2).toString());
        ...
        String[] row = {
            ...
            namaBarangString,
            String.valueOf(hargaBeliInt),
            String.valueOf(jumlahInt),
            String.valueOf(hargaBeliInt * jumlahInt)
        };        
        ...
        notaModel.setValueAt(hargaBeliInt * (jumlahTable - jumlahInt), tableNota.getSelectedRow(), 4);
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        int hargaBeliInt = Integer.parseInt(returModel.getValueAt(tableRetur.getSelectedRow(), 2).toString());
        ...
        if (indeks != -1) {
            ...
            notaModel.setValueAt(hargaBeliInt * (jumlahTable + jumlahInt), indeks, 4);
        }
    ...
    private void simpanButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanButtonActionPerformed
        ...
        String tanggalReturString = tanggalRetur.getSelectedItem().toString();
        
        
        // get SQL Date
        java.sql.Date sqlReturDate = GeneralFunction.date2SQLDate(tanggalReturString);
        ...
        try (java.sql.PreparedStatement stmt = cons.prepareStatement("SELECT tanggal_nota "
                + "FROM beli WHERE nomor_nota = ? LIMIT 1"))
        {
        ...
        // delete data from db beli
        try (java.sql.PreparedStatement stmt = cons.prepareStatement("DELETE FROM beli WHERE nomor_nota = ?"))
        {
            stmt.setString(1, nomorNotaString);
            stmt.execute();
        } catch (java.sql.SQLException e) {
        ...
        // insert ulang ke db
        String query = "INSERT INTO beli (id, id_client, "
        ...
        try (java.sql.PreparedStatement stmt = cons.prepareStatement(query))
        {
            for (int i = 0; i < notaModel.getRowCount(); i++) {
                ...
                int hargaBeliInt = Integer.parseInt(notaModel.getValueAt(i, 2).toString());
                ...
                stmt.setInt(6, hargaBeliInt);
                stmt.setInt(7, jumlahInt);
                stmt.setInt(8, totalHargaInt);
                stmt.setDouble(9, diskonNota);
        ...
        // get nilai_nota lama di bnota
        int nilaiNotaLama = 0;
        try (java.sql.PreparedStatement stmt = cons.prepareStatement("SELECT nilai_nota FROM bnota WHERE nomor_nota = ?"))
        {
            stmt.setString(1, nomorNotaString);
            java.sql.ResultSet resultSet = stmt.executeQuery();
            while (resultSet.next()) {
        ...
        // update nilai_nota dan saldo_nota di bnota
        try (java.sql.PreparedStatement stmt = cons.prepareStatement("UPDATE bnota SET nilai_nota = ?, "
        ...
        // kurangi sldakhir_utang client dengan nilai_nota lama
        try (java.sql.PreparedStatement stmt = cons.prepareStatement("UPDATE client "
                + "SET sldakhir_utang = sldakhir_utang - ? WHERE id = ?"))
        {
        ...
        // tambah sldakhir_utang client dengan nilai_nota baru
        try (java.sql.PreparedStatement stmt = cons.prepareStatement("UPDATE client "
                + "SET sldakhir_utang = sldakhir_utang + ? WHERE id = ?"))
        {
            stmt.setInt(1, Integer.parseInt(nilaiNota.getText()));
        ...
        // insert ke bretur
        query = "INSERT INTO bretur (id_client, id_beli, nomor_nota, tanggal_nota, nama_barang, "
                + "harga_barang, qty_barang, total_harga, tanggal_retur) VALUES "
                + "(?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        try (java.sql.PreparedStatement stmt = cons.prepareStatement(query))
        {
            for (int i = 0; i < returModel.getRowCount(); i++) {
                ...
                int hargaBeliInt = Integer.parseInt(returModel.getValueAt(i, 2).toString());
        ...
        try {
            cons.close();
            javax.swing.JOptionPane.showMessageDialog(null, "Success retur barang", "ERROR", javax.swing.JOptionPane.INFORMATION_MESSAGE);
        } catch (java.sql.SQLException e) {
            javax.swing.JOptionPane.showMessageDialog(null, e.getMessage(), "ERROR", javax.swing.JOptionPane.ERROR_MESSAGE);
        }
        new com.sa.cobacoba.MainWindow().setVisible(true);
    ...
    private void setNota() {
        ...
        try (java.sql.PreparedStatement stmt = cons.prepareStatement("SELECT id, nama_barang, harga_barang, "
                + "qty_barang, total_harga, diskon_nota FROM beli WHERE nomor_nota = ?"))
        {
    ...
    private void updateHarga() {
        ...
        for (int i = 0; i < tblModel.getRowCount(); i++) {
            long hargaLong = Long.parseLong(tblModel.getValueAt(i, 4).toString());
            hargaTotalLong += hargaLong;
        }
        double diskonLong = Double.parseDouble(diskon.getText());
        long totalHargaDiskonLong = hargaTotalLong - Math.round(hargaTotalLong * diskonLong);
        nilaiNota.setText(String.valueOf(totalHargaDiskonLong));
    }
    
    private boolean validateAll() {
        try (java.sql.PreparedStatement stmt = cons.prepareStatement("SELECT lunas_nota FROM bnota WHERE nomor_nota = ?"))
        {
            namaClient.getSelectedItem().toString();
            
            String nomorNotaString = nomorNota.getSelectedItem().toString();
            
            if (tanggalRetur.getSelectedItem().toString().isEmpty())
                throw new java.lang.NullPointerException("Tanggal Retur tidak boleh kosong");
    ...
    private javax.swing.JComboBox<String> tanggalRetur;
