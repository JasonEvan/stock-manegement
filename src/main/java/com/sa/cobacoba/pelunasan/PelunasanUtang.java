...
public class PelunasanUtang extends javax.swing.JPanel {

    java.sql.Connection cons;
    javax.swing.JFrame parentFrame;
    public PelunasanUtang(java.sql.Connection conn, javax.swing.JFrame parentFrame) {
        cons = conn;
    ...
    private void nomorNotaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nomorNotaActionPerformed
        ...
        try (java.sql.PreparedStatement stmt = cons.prepareStatement("SELECT saldo_nota FROM bnota WHERE nomor_nota = ?"))
        {
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        int saldoNotaInt = 0;
        int nilaiNotaInt = 0;
        try (java.sql.PreparedStatement stmt = cons.prepareStatement("SELECT saldo_nota, nilai_nota FROM bnota "
                    + "WHERE nomor_nota = ?"))
        {
    ...
    private void pelunasanButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pelunasanButtonActionPerformed
        ...
        // update lunas_nota dan saldo_nota di bnota
        ...
        // insert ke blunas
            try (java.sql.PreparedStatement stmt = cons.prepareStatement("INSERT INTO blunas "
